...
func (v *SemVer) Bump(bump int) error {
	switch bump {
	case MAJOR_VERSION:
		v.Major += 1
		v.Minor = 0
...
// type to alpha.
func (v *SemVer) BumpPrerelease() error {
	if v.PrereleaseType == "" {
...
func (v *SemVer) SetMetadata(metadata string) {
	if metadata != "" {
		v.Metadata = metadata
	} else {
		v.Metadata = "build"
...
func (v *SemVer) ParseString(version string) error {
